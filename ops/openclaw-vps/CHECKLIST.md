...
- [ ] Choose a Linux VPS provider
- [ ] Use a recent Ubuntu LTS image
- [ ] Allocate enough resources for OpenClaw and later workflows
...
- [ ] Choose the LLM provider for the first hosted environment
- [ ] Gather the LLM API key
- [ ] Keep OANDA live credentials out of this environment
- [ ] If OANDA paper credentials already exist, store them separately and do not wire them yet
...
- [ ] Confirm OpenClaw still sees the selected LLM provider
- [ ] Confirm no paper/live credential mix-up exists
- [ ] Record the final VPS hostname/IP and access method

## 7. Exit criteria for Milestone 1

Milestone 1 is done when:
- [ ] OpenClaw runs on a Linux VPS
- [ ] Telegram is connected and working
- [ ] The hosted runtime restarts cleanly
- [ ] The environment is paper-only
